...
const translations = {
  es: {
    ...
    statusScaleUpdated: "Escala actualizada: {value} px/{unit}.",
    ...
    statusScaleCalibrated: "Escala calibrada: {value} px/{unit}.",
  ...
  ca: {
    ...
    statusScaleUpdated: "Escala actualitzada: {value} px/{unit}.",
  ...
  eu: {
    ...
    statusScaleUpdated: "Eskala eguneratuta: {value} px/{unit}.",
    ...
    statusScaleCalibrated: "Eskala kalibratuta: {value} px/{unit}.",
  ...
  en: {
    ...
    statusScaleUpdated: "Scale updated: {value} px/{unit}.",
    ...
    statusScaleCalibrated: "Scale calibrated: {value} px/{unit}.",
...
function applyCalibrationSettings() {
  ...
  setStatusKey("statusScaleCalibrated", {
    value: formatNumber(trackerState.scale.pixelsPerUnit, 2),
